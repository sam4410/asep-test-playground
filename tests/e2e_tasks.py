...
def test_task_management_flow(page: Page, username: str, password: str):
    ...
    # User Signup
    page.goto(f"{base_url}/static/index.html")  # Assuming the frontend is served at the static path
    ...
    # User Login
    page.goto(f"{base_url}/static/index.html")  # Redirect to login page
    page.fill("input[name='username']", username)
    page.fill("input[name='password']", password)
    ...
    # Get Tasks
    page.goto(f"{base_url}/static/index.html")  # Redirect to tasks page
    ...
    # Activity Log Check
    page.goto(f"{base_url}/static/index.html")  # Redirect to activity log page
