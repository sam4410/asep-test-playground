...
def test_flask_import(app):
    assert Flask is not None  # Ensure Flask is imported correctly
    assert session is not None  # Ensure session is imported correctly
    assert db is not None  # Ensure db is imported correctly
    assert User is not None  # Ensure User model is imported correctly
    assert Invoice is not None  # Ensure Invoice model is imported correctly
    assert init_app is not None  # Ensure init_app is imported correctly